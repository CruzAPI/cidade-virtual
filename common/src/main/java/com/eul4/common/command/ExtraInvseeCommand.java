...
import com.eul4.common.model.inventory.craft.CraftExtraInventory;
...
public class ExtraInvseeCommand implements TabExecutor
{
	public static final String COMMAND_NAME = "extra-invsee";
	...
	public boolean onCommand(CommandSender commandSender, Command command, String aliases, String[] args)
	{
		...
		if(args.length == 1)
		{
			...
			commonPlayer.openGui(new CraftExtraInventory(commonPlayer, playerTarget));
			return true;
		}
		else
		{
			messageable.sendMessage(COMMAND_EXTRAINVSEE_USE_$ALIASES, aliases);
			return false;
		}
	}
}