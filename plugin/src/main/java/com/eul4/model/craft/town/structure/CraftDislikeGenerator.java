...
public class CraftDislikeGenerator extends CraftGenerator implements DislikeGenerator
{
	...
	public CraftDislikeGenerator(Town town, TownBlock centerTownBlock)
	{
		this(town, centerTownBlock, false);
	}
	
	public CraftDislikeGenerator(Town town, TownBlock centerTownBlock, boolean isBuilt)
	{
	...
	{
		return town.getDislikesInGenerators();
	}
	
	@Override
	protected void setTownGeneratorsBalance(int balance)
	{
		town.setDislikesInGenerators(balance);
	}
	
	@Override
	protected DislikeGeneratorCollectEvent newGeneratorCollectEvent(int amountCollected)
	{
		return new DislikeGeneratorCollectEvent(town, amountCollected);
	}
}
